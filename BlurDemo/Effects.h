...
public:
	...
	void SetEyePosW(const XMFLOAT3& V) { EyePosW->SetRawValue(&V, 0, sizeof(XMFLOAT3)); } //Vector3 

	void SetFogColor(const FXMVECTOR V) { FogColor->SetFloatVector(reinterpret_cast<const float*>(&V)); } //Vector4
