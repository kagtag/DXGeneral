#include "TextureHillsAndWavesDemo.h"
...
void TexturedHillsAndWavesApp::UpdateScene(float dt)
{
	...
	//Every quarter sceond, generate a random wave
	...
	//
	//Animate water texture coordinate

	//Tile water texture
	XMMATRIX wavesScale = XMMatrixScaling(5.0f, 5.0f, 0.0f);

	//Translate water texture
	mWaterTexOffset.y += 0.05*dt;
...
bool TexturedHillsAndWavesApp::DrawScene()
{
	...
	for (UINT p = 0; p < techDesc.Passes; ++p)
	{
		...
		Effects::BasicFX->SetTexTransform(XMLoadFloat4x4(&mGrassTexTransform));//Texture coord transform
		...
		Effects::BasicFX->SetTexTransform(XMLoadFloat4x4(&mWaterTexTransform));//Texture coord transform
