...
void RenderStates::InitAll(ID3D11Device* device)
{
	...
	alphaToCoverageDesc.AlphaToCoverageEnable = true; //to make alpha to coverage performed per subpixel (default is per object)
	...
	HR(device->CreateBlendState(&noRenderTargetWritesDesc, &NoRenderTargetWriteBS));
	...
	// not rendering backfacing polygons, thus these settings do not matter
