...
void RenderStates::InitAll(ID3D11Device* device)
{
	...
	noCullDesc.CullMode = D3D11_CULL_NONE; //no culling
	...
	noRenderTargetWritesDesc.RenderTarget[0].BlendEnable = false; //disable blending
	...
	mirrorDesc.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ZERO; //will not write to depth buffer
	...
	mirrorDesc.FrontFace.StencilPassOp = D3D11_STENCIL_OP_REPLACE;//replace with 1, represent visible part of mirror
	...
	noDoubleBlendDesc.FrontFace.StencilFunc = D3D11_COMPARISON_EQUAL; //=0? no shadow, =1? already have shadow
