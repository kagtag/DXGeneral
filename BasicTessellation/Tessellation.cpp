...
{
	m_mainWndCaption = L"Basic Tessellation Demo";
...
bool BasicTessellation::DrawScene()
{
	...
	m_d3dImmediateContext->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_4_CONTROL_POINT_PATCHLIST);
	...
	for (UINT p = 0; p < techDesc.Passes; ++p)
	{
		...
		Effects::TessellationFX->TessTech->GetPassByIndex(0)->Apply(0, m_d3dImmediateContext);

		m_d3dImmediateContext->RSSetState(RenderStates::WireframeRS);
		m_d3dImmediateContext->Draw(4, 0);
	}
