...
void CommonApp::UpdateScene(float dt)
{
	//
	// Control the camera.
	//
...
void CommonApp::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void CommonApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void CommonApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
#pragma region ShapesBaseApp

ShapesBaseApp::ShapesBaseApp(HINSTANCE hInstance)
	:CommonApp(hInstance),
...
void ShapesBaseApp::BuildShapeGeometryBuffers()
{
...
void ShapesBaseApp::BuildSkullGeometryBuffers()
{
